...
- [ ] 1. Create IndexVisualization component structure
...
- [ ] 2. Implement data fetching using existing API
  - [ ] 2.1 Create custom hook for index shard data
  ...
  - [ ] 2.2 Fetch node information using existing API
