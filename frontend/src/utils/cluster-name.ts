 ...
 * Requirements: 3.1, 3.2
 */
export function resolveClusterName(clusterInfo: ClusterInfo, configName?: string): string {
 ...
 * Requirements: 3.1, 3.2
 */
export function getClusterNameInfo(clusterInfo: ClusterInfo, configName?: string): ClusterNameInfo {
  return {
