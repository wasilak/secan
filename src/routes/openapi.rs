...
#[openapi(
    ...
    paths(
        ...
        // Topology Sankey
        crate::routes::topology::sankey::get_sankey,
    ...
    components(
        schemas(
            ...
            // Topology Sankey types
            crate::routes::topology::sankey::SankeyDataResponse,
            crate::routes::topology::sankey::SankeyNodeResponse,
            crate::routes::topology::sankey::SankeyLinkResponse,
