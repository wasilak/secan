...
* [Cluster Details](/1.1/1.0/features/cluster-details) - View all indices in a cluster
* [Shard Management](/1.1/1.0/features/shard-management) - Manage shard allocation
* [REST Console](/1.1/1.0/features/rest-console) - Execute custom Elasticsearch queries
