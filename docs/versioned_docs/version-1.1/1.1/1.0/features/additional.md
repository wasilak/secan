...
* [REST Console](/1.1/1.0/features/rest-console) - Execute custom API calls for advanced management
* [Index Management](/1.1/1.0/features/index-management) - Manage individual indices
* [Cluster Details](/1.1/1.0/features/cluster-details) - View cluster status and nodes
