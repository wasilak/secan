...
1. Read the [Configuration guide](/1.1/1.0/configuration/authentication) to set up authentication and clusters
2. Learn about [Features](/1.1/1.0/features/dashboard) and what you can do with Secan
3. Check out [Cluster Details](/1.1/1.0/features/cluster-details) to understand the interface
