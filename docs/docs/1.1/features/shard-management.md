...
* [Cluster Details](/1.1/features/cluster-details) - View cluster and node status
* [Index Management](/1.1/features/index-management) - Manage indices
* [REST Console](/1.1/features/rest-console) - Execute shard allocation APIs directly
