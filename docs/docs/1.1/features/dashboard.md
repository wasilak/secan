...
Click on any cluster in the table to navigate to the [Cluster Details](/1.1/features/cluster-details) page where you can explore nodes, indices, and perform management operations.

## What's Next

Once you've identified a cluster to manage, proceed to [Cluster Details](/1.1/features/cluster-details) to explore nodes, indices, and other cluster-specific features.
