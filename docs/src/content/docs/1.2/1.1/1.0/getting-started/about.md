...
slug: 1.2/1.1/1.0/getting-started/about
---
...
Ready to get started? Check out the [Installation guide](/1.2/1.1/1.0/getting-started/installation/) to download and run Secan.
