...
slug: 1.2/1.1/features/rest-console
---
...
* [Cluster Details](/1.2/1.1/features/cluster-details/) - View cluster overview
* [Index Management](/1.2/1.1/features/index-management/) - Manage indices with UI
