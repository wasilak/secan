...
slug: 1.2/1.1/features/additional
---
...
* [REST Console](/1.2/1.1/features/rest-console/) - Execute custom API calls for advanced management
* [Index Management](/1.2/1.1/features/index-management/) - Manage individual indices
* [Cluster Details](/1.2/1.1/features/cluster-details/) - View cluster status and nodes
