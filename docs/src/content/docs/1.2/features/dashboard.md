...
The dashboard displays version information for each cluster:

* **Elasticsearch/OpenSearch Version**: Latest version across all nodes in the cluster
* **Supported Versions**: Secan supports Elasticsearch 7.x, 8.x, 9.x and OpenSearch 1.x, 2.x

### Cluster Selection

Click on any cluster in the table to navigate to the [Cluster Details](/1.2/features/cluster-details/) page where you can explore nodes, indices, and perform management operations.

### Dashboard Statistics

The dashboard includes detailed statistics for each cluster:

* **Real-time Health Status**: Continuously updated cluster health (green, yellow, red)
* **Capacity Planning**: Node count helps you understand cluster size
* **Index Organization**: Index and document counts for capacity analysis
* **Storage Metrics**: Document and shard distributions across the cluster

## What's Next

Once you've identified a cluster to manage, proceed to [Cluster Details](/1.2/features/cluster-details/) to explore nodes, indices, and other cluster-specific features.
