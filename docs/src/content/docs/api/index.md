...
### [Config Module](/api/secan/config/index.html)
...
### [Auth Module](/api/secan/auth/index.html)
...
### [Cluster Module](/api/secan/cluster/index.html)
...
### [Routes Module](/api/secan/routes/index.html)
...
### [Cache Module](/api/secan/cache/index.html)
...
### [Server Module](/api/secan/server/index.html)
...
### [TLS Module](/api/secan/tls/index.html)
...
See the [Cluster Module](/api/secan/cluster/index.html) for operations like:
...
See the [Auth Module](/api/secan/auth/index.html) for:
- User verification
- Session management
- RBAC evaluation
- Rate limiting
...
See the [Config Module](/api/secan/config/index.html) for:
- Loading from YAML
...
1. Read the [Config Module](/api/secan/config/index.html) to understand configuration loading
2. Check the [Routes Module](/api/secan/routes/index.html) to see existing API endpoints
3. Review the [Cluster Module](/api/secan/cluster/index.html) for cluster communication patterns
4. Examine [Auth Module](/api/secan/auth/index.html) for authentication integration
