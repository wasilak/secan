...
- Task command runner (optional, but recommended)
...
task dev              # Run development servers (backend + frontend)
...
- Run `task docs-dev` to preview changes locally
